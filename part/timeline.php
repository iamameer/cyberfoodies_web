<?php 
    ...
    //                     <div class="uk-card-header">
    //                         <div class="uk-grid-small uk-flex-middle" uk-grid>
    //                             <h3 class="uk-card-title"><time datetime="2021-03-09">March 09 2021</time></h3>
    //                             <span class="uk-label '.$flag_orange.' uk-margin-auto-left">Beta</span>
    //                         </div>
    //                     </div>
    //                     <div class="uk-card-body">
    //                         <p class="default">
    //                         Open beta test started!
    //                         </p>
    //                     </div>
    //                 </div>
    //             </div>
