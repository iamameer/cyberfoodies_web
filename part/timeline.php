<?php 
    ...
    $timeline = array(
        ...
        array("check","4th April 2021",$flag_green,"FEATURE",$text_green,
        "Lots of new features! 
            <ul>
                <li>Feature: Automatic status (open/close)</li>
                <li>New page: <a href='shoutout.php'>Pasar!</a></li>
                <li>Feature: Magically detect any links!</li> 
            </ul>"),
